...
def validate_gss():
    ...
    # Step 8: Decision
    print("═══════════════════════════════════════════════════════════════════════════════")
    print("VALIDATION METHOD: Future-Truth with ATR-based dynamic thresholds")
    print("Regime labels based on 5-day lookahead: BULL/BEAR if move > 1.5×ATR, else SIDEWAYS")
