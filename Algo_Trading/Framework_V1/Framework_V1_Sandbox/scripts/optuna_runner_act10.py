...
activation_threshold search range: 1.0 – 3.0 ATR  (step 0.5)
...
def objective(trial):
    ...
    if sv in ("B", "C"):
        ...
        params["activation_threshold"] = trial.suggest_float("activation_threshold", 1.0, 3.0, step=0.5)
...
print(f"  Config: activation_threshold range 1.0 – 3.0 ATR | FF enabled\n", flush=True)
...
print("\n" + "=" * 65)
print("OPTUNA RESULTS — ACT10 (activation 1.0–3.0) | FF ENABLED")
print("=" * 65)
