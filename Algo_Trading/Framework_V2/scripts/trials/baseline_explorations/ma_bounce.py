...
sharpe_all = sharpe(all_trades)
print(f"TOTAL  N={n_all}  Prof_WR={prof_all/n_all*100:.1f}%  BE_prof={be_prof_all:.1f}%  Pure_WR={pure_all/n_all*100:.1f}%  BE_pure={be_pure:.1f}%  PF={pf_all:.3f}  Sharpe={sharpe_all}  Net={all_df['pnl'].sum():.2f}")
