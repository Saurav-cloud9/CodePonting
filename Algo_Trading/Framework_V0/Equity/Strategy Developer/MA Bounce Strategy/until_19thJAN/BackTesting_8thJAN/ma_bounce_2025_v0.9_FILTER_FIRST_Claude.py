...
def run_backtest(df):
    ...
    for i in range(len(df)):
        ...
        # For each filter that passed (at candle i, before dip)
    ...
    print(f"✓ Candles in uptrend (any filter): {candles_in_uptrend}")
    print(f"✓ Bounces detected (in uptrend): {bounces_detected}")
