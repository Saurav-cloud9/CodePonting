...
def run_ma_bounce(df, stock_name):
    ...
    # Simple scaling: If profit is ₹X per share, scaled profit = ₹X × 1000
    scaled_profit_1000x = best_result['net_profit'] * 1000
    ...
    return {
        ...
        'scaled_profit_1000x': scaled_profit_1000x,  # Simple 1000× multiplier
    ...
    with pd.ExcelWriter(filename, engine='openpyxl') as writer:
        ...
        for result in all_results:
            summary_data.append({
                ...
                'Scaled Profit (₹1000×)': round(result['scaled_profit_1000x'], 2),
        ...
        df_winners = pd.DataFrame([{
            ...
            'Scaled Profit (₹1000×)': round(r['scaled_profit_1000x'], 2),
        ...
        for category, stocks in pattern_data.items():
            ...
            pattern_rows.append(['Stock', 'Best Filter', 'Net Profit (₹)', 'Scaled Profit (₹1000×)', 'Win Rate (%)', 'Trades', 'Avg Price (₹)'])
            ...
            for stock in sorted(stocks, key=lambda x: x['net_profit'], reverse=True):
                pattern_rows.append([
                    ...
                    round(stock['scaled_profit_1000x'], 2),
