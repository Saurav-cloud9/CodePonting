...
def get_ma20_buggy(instrument):
    """Calculate MA20 using BUGGY code (candles[-100:])"""
    try:
        all_candles, num_minutes = get_historical_candles(instrument, 100)
...
def run_comparison_test():
    ...
    for stock, instrument in TEST_STOCKS.items():
        ...
        buggy_ma20, buggy_timestamps = get_ma20_buggy(instrument)
        
        # Calculate with FIXED code
        fixed_ma20, fixed_timestamps = get_ma20_fixed(instrument)
